...
export function Sidebar() {
  ...
  return (
    <>
      ...
      >
        {/* Logo */}
        <div className="flex items-center gap-3 px-4 h-16 border-b border-farm-800 flex-shrink-0">
          ...
          {sidebarOpen && (
            <div className="overflow-hidden">
              ...
              <p className="text-farm-300 text-xs">Riverdale Station</p>
            </div>
          )}
        </div>
        ...
        {sidebarOpen && (
          <div className="px-4 py-3 border-t border-farm-800 flex-shrink-0">
            <div className="flex items-center gap-2">
              <div className="w-7 h-7 rounded-full bg-farm-600 flex items-center justify-center text-xs font-bold">JM</div>
              <div className="overflow-hidden">
                <p className="text-xs font-semibold text-white truncate">James Mackenzie</p>
                <p className="text-xs text-farm-400 truncate">Owner</p>
              </div>
            </div>
          </div>
        )}
